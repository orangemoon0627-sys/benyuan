...
function TheaterFallback() {
  return (
    <GlassPanel>
      <SectionTitle label="Loading" title="剧场正在调入。" description="如果上一幕已经完成，专属脚本会在这里接住你。" />
    </GlassPanel>
  );
}
...
export default function TheaterPage() {
  return (
    <FrameworkPage
      ...
      title="让选择像一次对话，而不是一次提交。"
      description="剧场会直接读取导演 Agent 生成的三幕脚本，记录你的行动、犹豫与镜像回答，并把这些轨迹交给后续的精神分析师。"
      actions={
        <>
