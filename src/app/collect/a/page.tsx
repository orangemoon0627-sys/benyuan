...
export default async function CollectAPage({ searchParams }: CollectModulePageProps) {
  ...
  return (
    <PageScaffold>
      ...
      <BenyuanPart1Workflow moduleFilter="A" showAuxiliaryPanels={resolvedSearchParams.debug === "1"} />
    </PageScaffold>
  );
}
