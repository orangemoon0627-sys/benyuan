...
export const liteQuestionContentV2: QuestionDef[] = [
  {
    questionId: "Q001",
  ...
  },
  {
    ...
    answerType: "single",
    prompt: "面对一件还没想清楚、但已经逼近眼前的事，你通常会先怎么做？",
    options: ["先把线索摊开，找出结构", "先记住第一反应，之后再验证", "先去和人说一说，在对话里整理自己", "先动一点，让现实给我反馈", "先退后一步，观察自己为什么会被它牵动"],
    presentation: { helperText: "这题不是测聪明，而是看你习惯怎样抵达清晰。" },
  },
  {
    questionId: "Q011",
