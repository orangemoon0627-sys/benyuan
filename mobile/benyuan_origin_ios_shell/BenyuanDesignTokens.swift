...
enum BenyuanColor {
    ...
    static let bgAbyss = Color(red: 7.0 / 255.0, green: 7.0 / 255.0, blue: 18.0 / 255.0)
    static let bgSurface = Color(red: 14.0 / 255.0, green: 14.0 / 255.0, blue: 26.0 / 255.0)
    static let aubergineBlack = Color(red: 14.0 / 255.0, green: 10.0 / 255.0, blue: 22.0 / 255.0)
    static let lunarBlue = Color(red: 12.0 / 255.0, green: 12.0 / 255.0, blue: 28.0 / 255.0)
    static let lunarBlueDeep = Color(red: 5.0 / 255.0, green: 5.0 / 255.0, blue: 16.0 / 255.0)
    static let nebulaViolet = Color(red: 34.0 / 255.0, green: 27.0 / 255.0, blue: 48.0 / 255.0)
    static let planetEdge = Color(red: 98.0 / 255.0, green: 84.0 / 255.0, blue: 112.0 / 255.0)
    static let glassFill = Color(red: 238.0 / 255.0, green: 241.0 / 255.0, blue: 255.0 / 255.0).opacity(0.060)
    static let glassFillStrong = Color(red: 238.0 / 255.0, green: 241.0 / 255.0, blue: 255.0 / 255.0).opacity(0.090)
    static let glassStroke = Color(red: 225.0 / 255.0, green: 230.0 / 255.0, blue: 255.0 / 255.0).opacity(0.13)
